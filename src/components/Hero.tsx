      ...
      <div className="container px-4 mx-auto relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center px-4 py-2 bg-clipgenius-purple/10 rounded-full mb-8 gap-2">
            ...
            <span className="text-sm font-medium text-clipgenius-purple">AI-Powered Video Transformation</span>
          </div>
          ...
          <p className="text-lg md:text-xl text-white/70 mb-10 max-w-2xl mx-auto">
            ClipGenius automatically converts your podcasts, interviews, and lectures into
            engaging short-form content for TikTok and YouTube Shorts.
          </p>
